  ...
  check : () => {
    ...
    if (bj.player.length==2 && bj.dealer.length==2) {
      ...
      if (winner==null && bj.dpoints==21) {
        winner = 1; message = "Sprocket wins with a Blackjack!"; 
      }
    }
    ...
    if (winner == null) {
      // PLAYER GONE BUST
      if (bj.ppoints>21) {
        winner = 1; message = "Player has gone bust - Sprocket wins!";
      }
      // DEALER GONE BUST
      if (bj.dpoints>21) {
        winner = 0; message = "Sprocket has gone bust - Player wins!";
      }
    }
    ...
    if (winner == null && bj.dstand && bj.pstand) {
      ...
      if (bj.dpoints > bj.ppoints) {
        winner = 1; message = "Sprocket wins with " + bj.dpoints + " points!";
      }
